...
### patient-mgmt-5: Create Patient - Email Registration Link
**Description:** Can create temporary patient and send registration link
**Steps:**
1. Open add patient form
2. Fill name and email only
3. Click "Save & Email Registration Link"
**Expected:**
- Temporary patient created
- Registration link sent to email
- Patient marked as temporary
**Code References:**
